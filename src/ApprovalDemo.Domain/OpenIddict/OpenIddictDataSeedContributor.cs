...
namespace ApprovalDemo.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ApprovalDemo") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ApprovalDemo", DisplayName = "ApprovalDemo API", Resources = { "ApprovalDemo" }
            });
        }
    }
